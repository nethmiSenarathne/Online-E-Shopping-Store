...
<div class = "container"> 
	<div class="row">
		...
		<h1 style="color:White;" >Seller Management</h1>
<div style="background-image: url('yellow.jfif');">
	<form id="formItem" name="formItem"  >
		 ...
		 Company name:
		 <input id="CompanyName" name="CompanyName" type="text" class="form-control form-control-sm"><br>
