	...
	//A common method to connect to the DB
		...
		{ 
			...
			{ 
				...
				String query = " insert into sellers (`SellersId`,`FirstName`,`LastName`,`ContactNumber`,`Email`,`CompanyName`)"
							+ " values (?, ?, ?, ?, ?, ?)"; 
		...
		{ 
			 ...
			 { 
				 	...
				 	// create a prepared statement
				 	String query = "UPDATE sellers SET FirstName=?,LastName=?,ContactNumber=?,Email=?,CompanyName=? WHERE SellersId=?"; 
		...
		{ 
		 	...
		 	{ 
		 			...
		 			// create a prepared statement
		 			String query = "delete from sellers where SellersId =?"; 
