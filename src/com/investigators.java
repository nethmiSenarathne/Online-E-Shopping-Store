	...
	///A common method to connect to the DB
		...
		{ 
			...
			{ 
				...
				String query = " insert into investigators (`InvestID`,`FirstName`,`LastName`,`Email`,`ContactNumber`,`Location`)"
							+ " values (?, ?, ?, ?, ?,?)"; 
		...
		public String readItems() 
		 { 
				...
				{ 
					...
					output = "<table border='1'><tr><th>F Name</th>"
				             +"<th>L Name</th><th>Email</th>"
				             + "<th>ContactNumber</th>"
				             + "<th>Location</th>"
					...
					String query = "select * from investigators"; 
		...
		{ 
			 ...
			 { 
				 	...
				 	String query = "UPDATE investigators SET FirstName=?,LastName=?,Email=?,ContactNumber=?,Location=? WHERE InvestID=?"; 
		...
		{ 
		 	...
		 	{ 
		 			...
		 			// create a prepared statement
		 			String query = "delete from investigators where InvestID=?"; 
